            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <!--<a class="nav-link" href="{{ url('/contact-home') }}">{{ __('Contact') }}</a>-->
                                <router-link class="nav-link" to="/contact">Contactos</router-link>

                            </li>
                            <li class="nav-item">
                                <!--<a class="nav-link" href="{{ url('/excursiones-home') }}">{{ __('Excursions') }}</a>-->
                                <router-link class="nav-link" to="/excursion">Excursiones</router-link>
                            </li>
                            <li class="nav-item">
