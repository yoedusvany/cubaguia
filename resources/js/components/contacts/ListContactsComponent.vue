        ...
        <transition>
            <table class="table table-striped">
                ...
                <tr v-for="(item, index) in listContacts">
                    ...
                    <td>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#verContactModal"
                                v-on:click.prevent="setId(item.id)"><i class="fa fa-eye"></i> Ver
                        </button>
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#responderModal"
                                v-on:click.prevent="responderAction(item.email)"><i class="fa fa-reply"></i> Responder
                        </button>
                    </td>
                </tr>
